...
const Header = () => {
  return (
    <div className='relative   m-auto flex items-center justify-center lg:justify-start md:pb-20 xl:pb-0 -z-10'>
        <div className='max-w-[1440px] m-auto  w-full h-[748px] lg:h-[840px] bg-mobile md:bg-tablet xl:bg-desktop bg-cover  flex flex-col gap-6 justify-center items-center text-center xl:items-start xl:text-left  relative -z-10'>
            ...
            <img src={logo} alt="logo"  className='relative w-20  mt-[25%]  md:mt-[350px] lg:mt-[450px] xl:mt-[-50px] xl:ml-20 xl:w-28  '/>
