...
const Section = () => {
  return (
    <div  className='relative  m-auto flex items-center justify-center  overflow-hidden z-20'>
        <div className='max-w-[1440px] m-auto mb-20 w-full -mt-12 relative z-50'>
            <div className='flex flex-col justify-center items-center  text-center gap-7 mt-[-70px] md:mt-[-60px] relative xl:flex-row xl:justify-start xl:ml-20 z-50 '>
            ...
            <div className='flex flex-col  justify-center items-center text-center gap-7 mt-16 relative xl:flex-row-reverse xl:justify-start xl:ml-20 xl:gap-0 '>
                    <div className='relative md:mb-5 xl:mr-12  xl:mb-0'>
                        ...
                        <img src={curveLeft} alt="curva derecha" className='hidden xl:flex w-full h-80 absolute   -right-96 z-0 bottom-12 '  />   

                    <div className='flex flex-col justify-start items-center gap-6 mx-6 relative  md:w-full md:h-[250px] xl:text-left xl:items-start  xl:mx-0 xl:overflow-visible'>
                        <img src={divide} alt="divide" />
